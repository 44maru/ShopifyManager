...
const GET_ORDER_URL_TEMPLATE = "https://%s:%s@penguin-auto-buy-service.myshopify.com/admin/api/2020-07/orders.json?status=any&name=%s"

//const GET_ORDER_URL_TEMPLATE = "https://%s:%s@penguin-auto-buy-service.myshopify.com/admin/api/2020-07/orders.json?name=%s"
